  ...
  return (
    <div className="flex flex-col sm:flex-row justify-around items-center gap-4 p-4 rounded-2xl bg-card border border-border">
      <div className="text-center">
        ...
        <p className="text-xl font-bold text-income-text">{income.toLocaleString()}</p>
      </div>
      <div className="text-center">
        <p className="text-sm text-muted-foreground">支出合計</p>
        <p className="text-xl font-bold text-expense-text">{expense.toLocaleString()}</p>
      </div>
      <div className="text-center">
        <p className="text-sm text-muted-foreground">収支</p>
        <p className={`text-xl font-bold ${balance < 0 ? "text-expense-text" : "text-primary-text"}`}>
